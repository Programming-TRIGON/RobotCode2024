...
public class Intake extends MotorSubsystem {
    ...
    private void configureChangingDefaultCommand() {
        final Trigger shouldOpenByDefaultTrigger = new Trigger(() -> ((RobotContainer.ELEVATOR.isWithinHittingIntakeZone() || (RobotContainer.ELEVATOR.isClosing() && !RobotContainer.ELEVATOR.isClosed()))));
