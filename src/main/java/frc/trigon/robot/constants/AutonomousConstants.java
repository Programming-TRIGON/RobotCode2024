...
public class AutonomousConstants {
    ...
    private static void registerCommands() {
        ...
        NamedCommands.registerCommand("FeedNote", TransporterCommands.getSetTargetStateCommand(TransporterConstants.TransporterState.FEEDING).withTimeout(1.8).until(RobotContainer.SHOOTER::didShootNote));
