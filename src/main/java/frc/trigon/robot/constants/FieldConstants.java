...
public class FieldConstants {
    ...
    public static final Translation3d SPEAKER_TRANSLATION = TAG_ID_TO_POSE.get(SPEAKER_TAG_ID).getTranslation().plus(SPEAKER_TAG_TO_SPEAKER);
    public static final Pose2d IN_FRONT_OF_AMP_POSE = new Pose2d(1.842, 8.204 - 0.48, Rotation2d.fromDegrees(90));
