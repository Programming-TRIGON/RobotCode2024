...
public class OperatorConstants {
    ...
    private static final double DRIVER_CONTROLLER_DEADBAND = 0.05;
    ...
    public static final Trigger
            ...
            FACE_AMP_TRIGGER = DRIVER_CONTROLLER.x().and(SCORE_IN_AMP_TRIGGER.negate()),
            ...
            WARM_SPEAKER_SHOOTING_TRIGGER = OPERATOR_CONTROLLER.w().and(SHOOT_AT_SPEAKER_TRIGGER.negate()),
