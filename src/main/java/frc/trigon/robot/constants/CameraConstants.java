...
public class CameraConstants {
    ...
    private static final Transform3d
            ...
            new Rotation3d(Units.degreesToRadians(180), Units.degreesToRadians(-20), Units.degreesToRadians(135))
    ),
            REAR_RIGHT_CENTER_TO_CAMERA = new Transform3d(
                    new Translation3d(-0.353, -0.298, 0.282),
                    new Rotation3d(Units.degreesToRadians(180), Units.degreesToRadians(-20), Units.degreesToRadians(225))
            ),
