...
public class AprilTagCameraConstants {
    public static final Transform3d TAG_OFFSET = new Transform3d(0, 0, 0.005, new Rotation3d(0, 0, 0));
    static final double MAXIMUM_DISTANCE_FROM_TAG_FOR_PNP_METERS = 1.5;
    static final int CALCULATE_YAW_ITERATIONS = 5;
